...
/**
 * CHANGES TO scancodesToAscii.txt
 *
 * - Removed printf calls
 * - Commented out main and extchar 
 * - Moved constants to a header file (h/kbd.h)
 * - Modified capslock behaviour so it does not disable on keyup
 * 
 */
